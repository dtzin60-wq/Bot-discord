...
intents.message_content = True # Necessário para ler o comando .p
...
class FilaView(discord.ui.View):
    ...
    async def btn_normal(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.defer() # Apenas ignora para não dar "Interação falhou"
...
async def on_ready():
    ...
    try:
        # Sincroniza os comandos de barra (/criar_filas) com o Discord
...
async def criar_filas(interaction: discord.Interaction):
    # Envia o modal para a tela do usuário
...
async def perfil(ctx, membro: discord.Member = None):
    # Define o alvo como a menção, ou quem enviou o comando
    target_user = membro or ctx.author

    # Se respondeu a uma mensagem, puxa o autor daquela mensagem
    ...
    # Dados fake para teste (Serão conectados ao MongoDB depois)
    stats = {
        'vitorias': 0,
        'derrotas': 2,
        'consecutivas': 0,
...
# ==========================================
# LIGAR O BOT NA RAILWAY
# ==========================================
# Puxa o token das variáveis de ambiente da Railway
