    ...
    async def join(self, it: discord.Interaction, tipo):
        ...
        if len(self.jogadores)>=lim:
            ...
            try:
                ...
                # --- CORREÇÃO: APAGAR A MENSAGEM DE "CRIOU TÓPICO" ---
                # O Discord manda uma mensagem de sistema. Tentamos apagar a última mensagem do canal
                try:
